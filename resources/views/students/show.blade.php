...
@section('content')
    <div class="row add-student shadow-sm">
        <div class="col-md-4">
            <img src="{{ asset("/images/{$found_student->photo}") }}" alt="" class="img-fluid rounded-lg" width="310">
        </div>
        <div class="col-md-8">
            ...
            <div class="back-btn float-right">
                <a href="{{route("home")}}" class="text-primary rounded" style="background: #ececec; padding: 10px;">&#8592; Back</a>
            </div>
        </div>
    </div>
@endsection
